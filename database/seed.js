...
async function seedDatabase() {
    ...
    try {
        ...
        const tables = ['applications', 'mentor_bookings', 'project_members', 'event_registrations',
            'scholarships', 'mentors', 'projects', 'events', 'fields', 'users'];
    ...
    `, [adminPassword, studentPassword, studentPassword, studentPassword, studentPassword, studentPassword]);
