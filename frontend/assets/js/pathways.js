...
async function loadPathwayDetails() {
    ...
    if (!id) {
        ...
        document.getElementById('pathwayDesc').textContent = 'Select a pathway from the Fields page to view details.';
        container.innerHTML = '<div class="empty-state">No pathway selected. <a href="/fields">Go back to Fields</a></div>';
        return;
    }
