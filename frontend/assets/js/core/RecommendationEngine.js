...
const FieldMatchStrategy = {
    ...
    calculateScore(item, userState) {
        ...
        const itemTags = (item.tags || []).concat(item.category ? [item.category] : []).map(t => t.toLowerCase());
...
export class RecommendationEngine {
    constructor(store) {
        ...
        this.strategies = [FieldMatchStrategy, UrgencyStrategy, UserTagsStrategy, CognitiveNeedsStrategy];
    }
